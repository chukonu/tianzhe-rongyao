    ...
    angular.module('app').constant('r1s1', {
        ...
        regions: [
            ...
            },
            {
                id: 'xxr12',
                name: '巴拉那河',
                path: '62.11% 40.36%,60.55% 41.69%,61.25% 43.03%,60.03% 44.96%,58.82% 45.25%,58.48% 46.14%,58.82% 47.03%,57.61% 48.37%,57.61% 49.85%,57.44% 51.19%,57.79% 52.23%,58.13% 52.97%,58.13% 54.01%,57.79% 54.75%,57.27% 55.64%,56.57% 56.97%,55.54% 58.16%,55.19% 59.79%,54.33% 60.98%,54.15% 61.87%,53.81% 62.76%,52.60% 64.09%,52.60% 65.73%,53.63% 66.47%,55.19% 67.21%,54.50% 65.88%,56.23% 65.88%,56.92% 65.43%,56.40% 63.20%,54.33% 62.91%,55.36% 60.68%,56.75% 61.13%,58.13% 60.83%,58.82% 59.79%,58.48% 58.75%,59.17% 58.75%,60.03% 58.90%,60.73% 58.61%,60.90% 58.46%,61.59% 59.64%,62.11% 59.94%,62.80% 60.09%,63.67% 59.94%,64.36% 59.64%,64.53% 58.61%,64.01% 57.27%,63.15% 56.68%,62.46% 56.38%,62.63% 55.04%,63.32% 54.15%,64.19% 52.97%,65.22% 52.52%,65.74% 51.78%,66.09% 51.78%,66.26% 52.82%,67.65% 53.12%,68.86% 53.41%,69.72% 52.67%,70.24% 51.34%,69.20% 50.45%,67.99% 49.85%,68.34% 49.26%,68.86% 48.66%,69.38% 48.22%,70.24% 47.77%,71.28% 47.77%,71.80% 47.63%,73.18% 47.48%,74.05% 47.33%,74.57% 47.63%,74.57% 48.52%,75.26% 48.66%,75.95% 48.66%,76.12% 47.92%,75.95% 47.33%,75.61% 46.74%,75.09% 45.99%,74.22% 45.55%,73.36% 45.85%,71.97% 46.14%,70.24% 46.14%,68.51% 46.29%,67.30% 46.88%,66.61% 47.77%,65.40% 49.11%,64.01% 51.34%,62.11% 53.26%,61.42% 54.45%,60.73% 56.23%,59.86% 56.68%,58.30% 57.12%,59.00% 55.64%,60.21% 54.75%,60.38% 53.56%,59.34% 53.12%,59.00% 52.37%,59.00% 50.45%,59.17% 49.26%,59.86% 48.81%,60.55% 50.00%,60.73% 48.96%,61.59% 47.77%,62.28% 46.88%,61.59% 45.40%,61.25% 44.66%,61.76% 43.92%,62.11% 43.18%,61.59% 41.84%,62.11% 41.39%,62.46% 41.10%'
            },
            {
                id: 'xxr13',
                name: '麦哲伦海峡',
            ...
            },
            {
                id: 'xxr3',
                name: '阿空加瓜山',
                path: '25.78% 60.83%, 25.43% 63.80%, 30.28% 64.39%, 30.62% 66.17%, 35.99% 66.17%, 37.54% 66.02%, 39.97% 65.73%, 39.79% 63.20%, 37.89% 61.72%, 37.54% 61.13%'
            }
        ]
    })
})(angular)
