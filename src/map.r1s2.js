    ...
    angular.module('app').constant('r1s2', {
        ...
        regions: [
            ...
            },
            {
                id: '6',
                name: '恒河',
                path: '45.57% 18.31%,44.43% 20.14%,43.61% 21.27%,43.28% 22.96%,43.77% 24.08%,44.59% 25.21%,45.08% 26.06%,44.59% 26.76%,44.43% 28.03%,45.90% 29.01%,47.21% 29.86%,48.03% 30.85%,49.34% 31.55%,50.16% 32.11%,51.31% 32.68%,53.28% 33.38%,54.75% 33.80%,55.74% 34.23%,56.23% 34.93%,56.89% 35.49%,58.03% 35.63%,59.51% 35.63%,60.49% 35.63%,60.33% 34.37%,60.00% 33.52%,60.98% 33.10%,62.13% 33.10%,62.95% 32.96%,63.77% 32.82%,64.75% 32.82%,65.41% 33.38%,66.39% 33.80%,66.72% 34.37%,67.54% 35.07%,68.20% 35.49%,69.34% 35.49%,70.00% 35.35%,70.49% 34.79%,70.82% 34.08%,69.67% 32.54%,69.51% 31.55%,67.87% 31.55%,65.74% 31.13%,63.77% 30.70%,62.46% 30.28%,60.82% 30.42%,57.38% 30.85%,53.11% 31.13%,50.82% 31.13%,49.67% 30.99%,49.02% 30.70%,48.85% 28.87%,49.02% 28.03%,50.00% 27.61%,50.66% 27.46%,49.67% 26.34%,48.52% 25.63%,47.38% 23.94%,47.54% 22.68%,48.03% 22.11%,48.85% 21.69%,49.67% 21.83%,50.33% 21.55%,50.82% 20.70%,50.82% 20.28%'
            },
            {
                id: '7',
                name: '印度河',
            ...
            },
            {
                id: '17',
                name: '加尔各答',
                path: '73.28% 38.87%,74.10% 39.30%,74.10% 39.86%,73.28% 40.28%,72.62% 40.56%,71.97% 40.56%,71.15% 41.27%,69.51% 41.27%,60.33% 41.13%,60.49% 40.00%,60.33% 38.87%,61.31% 38.45%'
            },
            {
                id: '18',
                name: '卡拉奇',
